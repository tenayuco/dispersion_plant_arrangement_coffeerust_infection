...
Explanation: This code uses the superComputer's output and transforms it to a general dataBase *dataGeneralAverages_sens.csv*. It is not necessary to run it if one starts from *dataGeneralAverages_sens.csv*. 
...
setwd("./bajadaPatung_sens/dfPromedios/")
...
setwd("./bajadaPatung_sens/dfPromediosNEW/")
...
write.csv(datosFig_Espacio,"./dataGeneralAverages_sens.csv", row.names = FALSE)
