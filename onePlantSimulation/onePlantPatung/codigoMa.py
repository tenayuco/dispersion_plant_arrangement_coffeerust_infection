...
"""
Here all the parameters of the ODE equation can be mofidyed. For Figure 3 we only modifyed the g and io
"""
...
liga =  "patungDirectory"+ "/salida/matrix"
...
liga2 =  "patungDirectory"+ "/salida/dfLocal"
